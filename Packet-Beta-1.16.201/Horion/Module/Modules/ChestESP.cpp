...
void ChestESP::onPreRender(C_MinecraftUIRenderContext* renderCtx) {
	...
	for (auto iter = bufferedChestList.begin(); iter != bufferedChestList.end(); ++iter) {
		...
		if (storageID == 54) DrawUtils::setColor(255.f / 255.f, 255.f / 255.f, 255.f / 255.f, sexyMathHack); // Normal Chest
		if (storageID == 146) DrawUtils::setColor(1.f, 1.f, 1.f, sexyMathHack); // Trapped Chest
		if (storageID == 130) DrawUtils::setColor(111.f / 255.f, 55.f / 255.f, 161.f / 255.f, sexyMathHack); // Ender Chest
