...
void ModuleManager::initModules() {
	logF("Initializing modules");
	{
		...
		//this->moduleList.push_back(std::shared_ptr<IModule>(new HiveFlyTwo()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new Exploit9000FartFly()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new CubecraftConfig()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new HiveConfig()));
		this->moduleList.push_back(std::shared_ptr<IModule>(new HudModuleTwo()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new ChatBypass()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new AutoPlay()));
		...
		//this->moduleList.push_back(std::shared_ptr<IModule>(new NGFly()));
		...
		//this->moduleList.push_back(std::shared_ptr<IModule>(new VanillaFly()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new MinevilleFly()));
		//this->moduleList.push_back(std::shared_ptr<IModule>(new CubeCraftFly()));
		...
		//ths->moduleList.push_back(std::shared_ptr<IModule>(new NoWeb()));
		...
		//th>moduleList.push_back(std::shared_ptr<IModule>(new ExtendedBlockReach()));
		...
		//is->moduleList.push_back(std::shared_ptr<IModule>(new Waypoints()));
	...
	this->getModule<AutoSprint>()->setEnabled(true);
	this->getModule<HudModuleTwo>()->setEnabled(true);
...
void ModuleManager::onLoadConfig(void* confVoid) {
	...
	for (auto& mod : this->moduleList) {
		...
		nametagsMod->setEnabled(false);
		autoarmorMod->setEnabled(false);
		disablerMod->setEnabled(false);
	}
