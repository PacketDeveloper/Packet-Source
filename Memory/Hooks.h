...
#include "../Packet/Command/CommandMgr.h"
#include "../Packet/Config/ConfigManager.h"
#include "../Packet/DrawUtils.h"
#include "../Packet/ImmediateGui.h"
#include "../Packet/Menu/ClickGui.h"
...
private:
	...
	static void Actor_getRotation(C_Entity* _this, vec4_t& newAngle);
